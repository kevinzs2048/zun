...
class API(object):
    ...
    def capsule_create(self, context, new_capsule, extra_spec=None):
        host_state = None
        try:
    ...
    def capsule_show(self, context, capsule, *args):
        return self.rpcapi.capsule_show(context, capsule, *args)
